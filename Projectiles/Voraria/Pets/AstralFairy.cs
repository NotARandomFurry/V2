...
namespace V2.Projectiles.Voraria.Pets
{
	...
	public static partial class AstralFairyStuff
	{
		...
		public static double Size => 15.5;
	...
	public class AstralFairy : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (owner.CurrentCaptor() is null)
			{
		...
		public static Rectangle TumBounds(int size)
		{
			Rectangle bounds = new Rectangle(0, 0, 28, 24);
			switch (size)
			{
				case 0: bounds = new Rectangle(0, 0, 32, 24); break;
                case 1: bounds = new Rectangle(0, 24, 32, 26); break;
                case 2: bounds = new Rectangle(0, 50, 34, 28); break;
                case 3: bounds = new Rectangle(0, 78, 36, 34); break;
                case 4: bounds = new Rectangle(0, 112, 42, 40); break;
                case 5: bounds = new Rectangle(0, 152, 46, 44); break;
                case 6: bounds = new Rectangle(0, 196, 50, 48); break;
                case 7: bounds = new Rectangle(0, 244, 54, 54); break;
                case 8: bounds = new Rectangle(0, 298, 60, 62); break;
                case 9: bounds = new Rectangle(0, 360, 64, 70); break;
                case 10: bounds = new Rectangle(0, 430, 70, 76); break;
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
			...
			Rectangle TumBox = TumBounds(TumSize);
            Vector2 TumOffset = new Vector2(20, 64);
            if (Projectile.direction == -1) TumOffset = new Vector2(20 - (TumBox.Width - 24), 64);
            Texture2D spriteTum = ModContent.Request<Texture2D>(textTum).Value;
            Main.EntitySpriteDraw(spriteTum, Projectile.position - Main.screenPosition + new Vector2(0, Projectile.gfxOffY) + TumOffset, (Rectangle)TumBox, lightColor, Projectile.rotation, Vector2.Zero, 1f, spriteEffects, 0f);
            return false;
		}
	}
    ...
    public class AstralFairyController : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
			if (player.whoAmI == Main.myPlayer)
			{
				...
				if (astralFairy == null) return false;
