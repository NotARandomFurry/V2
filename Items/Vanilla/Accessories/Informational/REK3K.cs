...
{
	public class REK3K : GlobalItem
	{
		public override bool AppliesToEntity(Item entity, bool lateInstantiation) => entity.type == ItemID.REK;
			...
			if (V2Utils.FindLastTooltipLineBeforeFlavorText(tooltips, out TooltipLine line))
			{
				V2Utils.InsertNewTooltipLine(
					...
					Language.GetTextValue(
						"Mods.V2.ItemTooltip.Vanilla.Accessories.Informational.REK3K"
					)
				);
			}
		}
