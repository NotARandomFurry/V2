...
namespace V2.Items.Vanilla.Placeables.Tile
{
    ...
    {
        public override bool InstancePerEntity => true;
        public override bool AppliesToEntity(Item entity, bool lateInstantiation) => entity.type == ItemID.EbonstoneBlock || entity.type == ItemID.CrimstoneBlock || entity.type == ItemID.PearlstoneBlock;
