...
{
	public static class RainbowSlimeStuff
	{
		public static RainbowSlime AsRainbowSlime(this NPC npc)
		{
			if (!npc.TryGetGlobalNPC(out RainbowSlime RainbowSlime))
				throw new Exception("this instance of a Rainbow Slime, supposedly, doesn't exist");
	...
	public partial class RainbowSlime : GlobalNPC
	{
		...
		public static bool CanRainbowSlimeBeForceFed(NPC npc) => true;
		...
		{
			double baseDigestionTickDamage = 10.0;
