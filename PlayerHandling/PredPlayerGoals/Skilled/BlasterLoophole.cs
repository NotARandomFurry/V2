...
{
<<<<<<< Updated upstream:PlayerHandling/PredPlayerGoals/Amateur/BlasterLoophole.cs
...
=======
	public class BlasterLoophole : PredPlayerGoal
	{
		...
		public override bool Available(Player pred) => pred.HasItemInInventoryOrOpenVoidBag(ModContent.ItemType<DinnerBlaster>()) || Complete(pred);
		public override int StatPointsFromCompletion => 3;

		public override ProgressionStage Stage => ModContent.GetInstance<SkilledStage>();
	}
>>>>>>> Stashed changes:PlayerHandling/PredPlayerGoals/Skilled/BlasterLoophole.cs
}
