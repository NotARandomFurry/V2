...
namespace V2.PlayerHandling.PredPlayerGoals.Beginner
{
	public class EatFirstManaCrystal : PredPlayerGoal
	{
		...
		public override string DisplayName(Player pred) => Language.GetTextValue("Mods.V2.PredPlayerGoals.Beginner.EatFirstManaCrystal.Name");
		public override string Description(Player pred) => Language.GetTextValue("Mods.V2.PredPlayerGoals.Beginner.EatFirstManaCrystal.Description");
