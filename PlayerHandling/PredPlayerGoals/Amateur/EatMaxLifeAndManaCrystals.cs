...
namespace V2.PlayerHandling.PredPlayerGoals.Amateur
{
	public class EatMaxLifeAndManaCrystals : PredPlayerGoal
	{
		...
		public override string DisplayName(Player pred) => Language.GetTextValue("Mods.V2.PredPlayerGoals.Amateur.EatMaxLifeAndManaCrystals.Name");
		public override string Description(Player pred) => Language.GetTextValue("Mods.V2.PredPlayerGoals.Amateur.EatMaxLifeAndManaCrystals.Description");
